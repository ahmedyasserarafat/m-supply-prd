...
public class StoreConsumerApi extends DefaultApi10a {


	 private static final String AUTHORIZATION_URL = "http://localhost:9080/store/authorize?oauth_token=%s";	
	 private static final String BASE_URL = "http://localhost:9080/store/";
