...
public class MapExamples {
    ...
    public static void main(String[] args) {
    	Map<String, Map<String,String>> sells = new HashMap<>();
    	
    	HashMap<String, String> dd=new HashMap<String, String>();
    	dd.put("One", "jj");
    	sells.putIfAbsent("one", dd);
    	//System.out.println();
    	System.out.println("--"+sells.getOrDefault("oned",dd));
    	sells.computeIfAbsent("two", k->new HashMap<String, String>()).put("two", "jj");
    	sells.computeIfAbsent("hree", k->new HashMap<String, String>()).put("three", "jj");
    	sells.forEach((k,v)->System.out.println(k+"--"+v));
